...
public class AssignmentExpressionTreeImpl extends JavaScriptTree implements BinaryExpressionTree {
  ...
  public AssignmentExpressionTreeImpl(Kind kind, ExpressionTree leftOperand, InternalSyntaxToken operand, ExpressionTree rightOperand) {
    super(kind);
